            ...
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form name="memberRegisterFrm" method="post" class="space-y-4 md:space-y-6">
                    <div class="relative">
                        ...
                        <span class="guide ok text-green-700 absolute hidden top-10 end-1">사용 가능한 아이디 입니다.</span>
                        <span class="guide error text-red-700 absolute hidden top-10 end-1">이미 사용중인 아이디 입니다.</span>
                        <%-- idValid = 1은 사용가능한 아이디, idValid = 0은 사용불가한 아이디(제출되지 않음) --%>
                    ...
                    <div>
                        ...
                        <input type="date" name="birthday" id="birthday" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" value="1999-09-09">
                    </div>
                    <div>
                    ...
                    <fieldset>
                        ...
                        <div class="inline-flex items-center mr-5">
                            <input id="hobby-1" type="checkbox" name="hobby" value="운동" class="w-5 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2" >
                            <label for="hobby-1" class="ms-3 text-sm font-medium text-gray-900">운동</label>
                        </div>
                        <div class="inline-flex items-center mr-4">
