...
public class ELServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        String name = "홍길동";
        int num = 123;
        List<String> hobbies = Arrays.asList("독서", "넷플릭스", "맛집투어");
        Map<String, Integer> bookMap = Map.of("MyJava", 15_000, "정신이 나가기 전", 23_000, "Dr.zang's office", 30_000);
