 ...
 *
 */
@WebServlet("/testPerson2.do") // /hello-web/안적음
public class TestPersonPostServlet extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		// 응답 html 작성
		resp.setContentType("text/html; charset=utf-8"); // html타입으로 쓸게
		...
		String body = """
				...
				""".formatted(name, color, animal, Arrays.toString(foods)); // 입력값에 따라 결과가 달라지는 동적html
