...
-- mybatis는 RowBounds를 사용하면, 페이징처리를 대신해준다. (1(page)~10(limit), 11~20 . . .)
select
    *
from
    member
...
-- 첨부파일을 서버컴퓨터에 저장하고 저장된 파일의 정보만 db테이블에 저장한다.
...
insert into notification
values (seq_notification_id.nextval, 'abcde', 'NEW_CONTENT', 'qwerty가 새 게시글을 올렸습니다.', default, default);
