...
public class MemberServiceTest {
    ...
    @DisplayName("존재하지 않는 회원은 NULL이 된다")
    @Test
    public void test3() {
        Member member = memberService.findById("asdasdasdfafesdfasdfsdfdsf");
    ...
    public void test5() {
        String keyword = "무개";
        List<Member> members = memberService.fidByName(keyword);
        assertThat(members)
                .isNotNull()
                .isNotEmpty();
